...
<div id="notifications" class="container settings-container">
	...
	<div class="columns is-mobile is-centered is-gapless">
		...
		<div class="column">
			<a href="#" class="title is-size-7-mobile is-size-6-tablet is-spaced">Email Notification</a>
	...
	<div class="columns is-mobile is-centered is-gapless">
		...
		<div class="column">
			<a href="#" class="title is-size-7-mobile is-size-6-tablet is-spaced">Push Notifications</a>
...
<div id="profile" class="container settings-container">
	<h2 class="subtitle is-size-4-tablet is-size-5-mobile is-marginless">Profile</h2>
	<hr class="settings-hr">
	...
	<div class="columns is-mobile is-centered is-gapless">
		...
		<div class="column">
			...
			<p class="subtitle is-7 has-text-grey">Change your username</p>
		</div>
	</div>
	...
	<div class="columns is-mobile is-centered is-gapless">
		...
		<div class="column">
			...
			<p class="subtitle is-7 has-text-grey">Change your profile picture.</p>
		</div>
	</div>
</div>
...
<div id="privacy" class="container settings-container">
	...
	<div class="columns is-mobile is-centered is-gapless">
		...
		<div class="column">
			<a href="#" class="title is-size-7-mobile is-size-6-tablet is-spaced">Hide Profile</a>
